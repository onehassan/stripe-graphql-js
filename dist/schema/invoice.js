...
builder_1.builder.objectType('StripeInvoice', {
    ...
    fields: function (t) { return ({
        ...
        application: t.field({
            ...
            nullable: true,
            resolve: function (invoice) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, utils_1.stripe.subscriptions.retrieve(subscription)];
                        case 1:
                            subscriptionData = _a.sent();
                            return [2 /*return*/, subscriptionData];
                    }
                });
            }); }
        }),
